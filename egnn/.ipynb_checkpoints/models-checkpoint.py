...
class EGNN_dynamics_QM9(nn.Module):
    ...
    def _forward(self, t, xh, node_mask, edge_mask, context, compute_adj=True, h_2d=None, y_2d=None, adjs=None):
        ...
        if self.mode == 'egnn_dynamics':
            h_final, x_final, adj_final = self.egnn(h, x, edges, bs, n_nodes, node_mask=node_mask, edge_mask=edge_mask, h_2d=h_2d, y_2d=y_2d, adjs=adjs)
